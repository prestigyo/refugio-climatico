 ...
 *{margin:0;padding:0;box-sizing:border-box}
 ...
 .metodo b{color:var(--paper)}
 .sigue{border-top:1px solid var(--line);margin-top:24px;padding-top:18px}
 __NAVCSS__
 __FOOTERCSS__
</style>
</head>
...
<section><div class="wrap">
  <h2>De día: solo resisten las cumbres</h2>
  <p>¿Y de día? Aquí no hay refugio para casi nadie: en verano <b>España arde de sol a sol</b> — el 98&nbsp;% del territorio llega al rojo (32&nbsp;°C) algún día. Solo un puñado de <b>cumbres</b> aguanta fresco también a mediodía. Este mapa cuenta, punto por punto, cuántos días la máxima se quedó por debajo de __UMBRAL__&nbsp;°C.</p>
  <figure>
...
<section><div class="wrap">
  ...
  <div class="sigue">
    <p><b>Sigue explorando:</b> busca <a href="__SITE__/">tu pueblo en la calculadora</a>, localiza <a href="__SITE__/refugios-climaticos-naturales-cerca-de-mi/">el refugio climático natural más cercano</a>, mira <a href="__SITE__/ranking-noches-tropicales/">el ranking nacional</a>, sigue <a href="__SITE__/ola-de-calor/">el mapa de la ola de calor de hoy</a> o entiende <a href="__SITE__/microclimas/">por qué un valle es más fresco que la cima de al lado</a>.</p>
  </div>
</div></section>
